...
const Home = ({url}) => {
    ...
    <div className="sm:mx-10 mt-10 text-center ">
      <Link to="/articles" class=" cursor-pointer max-w-[300px] mb-6 p-2 bg-gray-700 rounded-full items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex">
